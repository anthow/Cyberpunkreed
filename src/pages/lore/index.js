   ...
   <article className="  w-9/12 m-auto  text-white">
       ...
       <Link to="./quartiers">
        <section className="flex mb-10 flex-col space-y-2 items-center">
            <StaticImage src="https://res.cloudinary.com/liono/image/upload/v1663410289/1398278-1rihbgcawla51-amp_main_img-1_qzxed1.png" alt="A dinosaur"  className=" rounded-full" />        
